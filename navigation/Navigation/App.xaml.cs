...
public partial class App : Application
{
	...
	private static void RegisterRoutes(IViewRegistry views, IRouteRegistry routes)
	{
		var messageDialog = new MessageDialogViewMap(
			...
			Buttons: [new DialogAction(Label: "Ok"), new DialogAction(Label: "Cancel")]
		);
		...
		views.Register(
			...
			new DataViewMap<
				FirstTabBarItemWithDataPage,
				FirstTabBarItemWithDataViewModel,
				Entity
			>(),
			new DataViewMap<
				SecondTabBarItemWithDataPage,
				SecondTabBarItemWithDataViewModel,
				Entity
			>(),
				...
				[
					new(
						...
						[
							...
							new(
								"PageNavigation",
								View: views.FindByViewModel<PageNavigationViewModel>(),
								IsDefault: true
							),
							new(
								"Sample",
								View: views.FindByView<SamplePage>(),
								DependsOn: "PageNavigation"
							),
							#endregion
							...
							new(
								"CControlNavigation",
								View: views.FindByView<CControlNavigationPage>()
							),
							new(
								"CControlRight",
								View: views.FindByView<CControlRightPage>(),
								DependsOn: "CControlNavigation"
							),
							#endregion
							...
							new(
								"TabBarNavigation",
								View: views.FindByView<TabBarNavigationPage>(),
								Nested:
								[
									new("TBOne"),
							...
							new(
								"TabBarWithData",
								View: views.FindByViewModel<TabBarWithDataViewModel>(),
								Nested:
								[
									new(
										"TBDataOne",
										View: views.FindByViewModel<FirstTabBarItemWithDataViewModel>()
									),
									new(
										"TBDataTwo",
										View: views.FindByViewModel<SecondTabBarItemWithDataViewModel>()
									),
								]
							),
							#endregion
							...
							new(
								"RequestValueMain",
								View: views.FindByViewModel<RequestValueMainViewModel>()
							),
							new(
								"RequestValueSecond",
								View: views.FindByViewModel<RequestValueSecondViewModel>(),
								DependsOn: "RequestValueMain"
							),
							#endregion
							...
							new(
								"MessageDialog",
								View: views.FindByViewModel<MessageDialogViewModel>()
							),
							...
							new(
								"ModalDialogSecond",
								View: views.FindByView<ModalDialogSecondPage>()
							),
							new("ModalContentDialog", View: views.FindByView<ModalContentDialog>()),
							new(
								"ComplexFlyout",
								View: views.FindByView<ComplexFlyoutPage>(),
								Nested:
								[
									new(
										"ComplexFlyoutOne",
										View: views.FindByViewModel<ComplexFlyoutOneViewModel>(),
										IsDefault: true
									),
									new(
										"ComplexFlyoutSecond",
										View: views.FindByViewModel<ComplexFlyoutTwoViewModel>(),
										DependsOn: "ComplexFlyoutOne"
									),
								]
							),
							#endregion
							...
							new(
								"ToFromQueryMain",
								View: views.FindByViewModel<ToFromQueryMainViewModel>()
							),
							new(
								"ToFromQuery",
								View: views.FindByViewModel<ToFromQueryViewModel>(),
								DependsOn: "ToFromQueryMain"
							),
							#endregion
							...
							new(
								"FlyoutDrawer",
								View: views.FindByView<FlyoutDrawerPage>(),
								Nested:
								[
